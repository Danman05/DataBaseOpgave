/*Lavet af Daniel, ZBC Ringsted H1*/
...
/*==============================================================*/
/* Show customers First and last name with telephone number     */
/*==============================================================*/
SELECT FirstName, LastName, Phone
FROM dbo.Customer

/*==============================================================*/
/* Product name with following distributers                     */
/*==============================================================*/
SELECT dbo.Product.ProductName, dbo.Supplier.CompanyName
FROM     dbo.Product INNER JOIN
dbo.Supplier ON dbo.Product.SupplierId = dbo.Supplier.Id

/*==============================================================*/
/* Order number with customers full name, using concat          */
/*==============================================================*/
SELECT CONCAT(dbo.Customer.FirstName, ' ', dbo.Customer.LastName,' : ', dbo.[Order].OrderNumber) AS 'FullName and ordernumber'
FROM     dbo.[Order] INNER JOIN
                  dbo.Customer ON dbo.[Order].CustomerId = dbo.Customer.Id

/*==============================================================*/
/* Orders with orderlines to following customer                 */
/*==============================================================*/
SELECT dbo.[Order].OrderNumber, dbo.Product.ProductName, dbo.Product.UnitPrice, dbo.Customer.FirstName, dbo.Customer.LastName, dbo.Customer.Country, dbo.Customer.Phone
FROM     dbo.[Order] INNER JOIN
                  dbo.Customer ON dbo.[Order].CustomerId = dbo.Customer.Id INNER JOIN
                  dbo.Product ON dbo.[Order].Id = dbo.Product.Id

/*==============================================================*/
/* Distributers with company name starting with A               */
/*==============================================================*/
SELECT CompanyName
FROM     dbo.Supplier
